...
class InternVLChatConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        self.use_pairwise_spatial_encoder = use_pairwise_spatial_encoder
    ...
    def to_dict(self):
        ...
        output['num_image_token_bev'] = self.num_image_token_bev
        output['num_image_token_ego'] = self.num_image_token_ego
        output['use_pairwise_spatial_encoder'] = self.use_pairwise_spatial_encoder
