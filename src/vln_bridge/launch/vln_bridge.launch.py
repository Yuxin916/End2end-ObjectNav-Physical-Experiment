...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument('depth_enable', default_value='true',
                              description='Enable depth image / scan-depth processing'),
        DeclareLaunchArgument('depth_topic', default_value='/camera/depth',
                              description='Depth topic aligned with the camera image'),
        DeclareLaunchArgument('camera_enable', default_value='true',
                              description='Enable camera subscription and egocentric RGB publishing'),
        DeclareLaunchArgument('camera_is_panorama', default_value='true',
                              description='Project panoramic camera images into egocentric RGB'),
        DeclareLaunchArgument('history_enable', default_value='true',
                              description='Enable trajectory history images for VLM prompts'),
    ...
    vlm_node = Node(
        ...
        parameters=[
            ...
            LaunchConfiguration('config_file'),
            {
                ...
                'depth_enable': LaunchConfiguration('depth_enable'),
                'depth_topic': LaunchConfiguration('depth_topic'),
                'camera_enable': LaunchConfiguration('camera_enable'),
                'camera_is_panorama': LaunchConfiguration('camera_is_panorama'),
                'history_enable': LaunchConfiguration('history_enable'),
