...
def evaluate_trajectories(vlm_policy, config):
    ...
    for ep_idx in tqdm(range(total_episodes), desc="Evaluating episodes"):
        ...
        elif vlm_policy.template in ["RGB_HisKFMultiColor_OccMultiColor", "RGB_HisKFMultiColor", "RGB_HisKFSingleColor", "RGB_HisKFMultiColor_OccSingleColor"]:
            pass
        else:
            ...
            if gt_warmup:
                ...
                if ref_path:
                    def rotate_toward(waypoint_target):
                        ...
                        nonlocal obs, rgbd, done, infos, step_idx, vis_data
                        while not done:
...
def parse_vlm_args():
    ...
    parser.add_argument("--output_template", type=str, default="pixel_GT_rotate",
                    choices=["pixel_GT_rotate"], help="Output template used for the model")
