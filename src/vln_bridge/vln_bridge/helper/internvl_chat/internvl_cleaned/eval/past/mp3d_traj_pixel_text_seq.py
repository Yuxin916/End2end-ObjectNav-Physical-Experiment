...
class VLMPolicy:
    ...
    def construct_prompt(self, instruction, rgb_img_padded, occupancy_single_color=None,history_5Interval1=None, history_5Interval3=None, history_5Interval5=None,
                         fpv_imags_multi_colored=None, fpv_imgs_single_colored=None, fpv_imgs_no_draw=None, occupancy_colored=None):
    ...
    def get_pixel(self, instruction, rgb_img_padded, generation_config, 
                  ...
                  fpv_imags_multi_colored=None, fpv_imgs_blue=None, fpv_imgs_no_draw=None, occupancy_colored=None):
...
def follow_toward_waypoint(waypoint, ts,
    ...
    obs, rgbd, infos, done, policy_agent, history_buffer, current_episode, possible_action_env, device, episode_rgb_history,
...
def evaluate_trajectories(vlm_policy, config):
    ...
    for ep_idx in tqdm(range(total_episodes), desc="Evaluating episodes"):
        ...
        elif vlm_policy.template in ["RGB_HisKFMultiColor_OccMultiColor", "RGB_HisKFMultiColor", "RGB_HisKFSingleColor", "RGB_HisKFnoColor",
                                     "RGB_HisKFMultiColor_OccSingleColor"]:
            pass
        else:
        ...
        while not done and step_idx < max_steps:
            ...
            elif vlm_policy.template in ["RGB_HisKFMultiColor_OccMultiColor", "RGB_HisKFMultiColor", "RGB_HisKFSingleColor", "RGB_HisKFnoColor", "RGB_HisKFMultiColor_OccSingleColor"]:
            ...
            if text_output == "SELECT_PIXEL":
                    ...
                    obs, rgbd, done, infos, steps_taken, episode_done, last_infos, actions, step_idx, \
                        episode_data, history_buffer, vis_data, episode_rgb_history, if_first_stop = follow_toward_waypoint(
                            ...
                            possible_action_env=list(envs.habitat_env.action_space.keys()), device=device, vis_data=vis_data,
                ...
                if text_output == "TURN_LEFT":
                    action_id = HabitatSimActions.turn_left
                    action_name = "TURN_LEFT"
                elif text_output == "TURN_RIGHT":
                    action_id = HabitatSimActions.turn_right
                    action_name = "TURN_RIGHT"
                elif text_output == "STOP":
...
def parse_vlm_args():
    ...
    parser.add_argument("--template", type=str,
                        choices=["RGB", "RGB_His5Interval1", "RGB_His5Interval3", "RGB_His5Interval5", 
                                 ...
                                 "RGB_HisKFnoColor", "RGB_HisKFMultiColor",
